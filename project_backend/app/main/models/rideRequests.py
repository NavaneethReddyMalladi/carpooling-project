...
class RideRequestsTable(db.Model):
    ...
    rider_id = db.Column(db.Integer, db.ForeignKey('user.user_id'), nullable=False)  # Change here
    ...
    rider = db.relationship('User', backref=db.backref('ride_requests', lazy=True))  # And here
